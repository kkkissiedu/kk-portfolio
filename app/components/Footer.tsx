...
export default function Footer({
  footerCopyright = "© 2026 Kwabena Kissiedu. All Rights Reserved.",
    ...
    <footer className="bg-anthracite border-t border-gold/10">
      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-8 lg:px-16 pt-16 pb-10">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
          {/* Logo */}
          <Link href="/" className="flex-shrink-0 group" aria-label="Kwabena Kissiedu — return to homepage">
            <span className="font-heading text-2xl font-bold text-cream group-hover:text-gold transition-colors duration-300">
              KK
            </span>
          </Link>
