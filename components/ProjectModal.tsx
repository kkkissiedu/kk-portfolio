          ...
          {activeProject.githubUrl && activeProject.category === "ml-research" && (
            <div className="shrink-0 px-6 py-3 border-b border-white/10 flex">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 text-xs tracking-[0.2em] uppercase text-gold border border-gold/40 hover:bg-gold/10 px-4 py-2 transition-colors"
              >
